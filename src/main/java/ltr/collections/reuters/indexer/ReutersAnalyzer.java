...
/**
 * Analizador textual dos documentos Reuters
 */
public class ReutersAnalyzer {
    static final Logger logger = Logger.getLogger(ReutersAnalyzer.class.getName());

    private boolean stemming;
    private boolean stopwords;
    private CharArraySet stopList = null;

    public ReutersAnalyzer(Boolean stemming, List<String> stopList) {
        this(stemming);
        if(stopList != null) {
    ...
    public ReutersAnalyzer(Boolean stemming){ //In case of no stopword removing
        this.stopwords = false;
        this.stemming = stemming;
    }

    public Analyzer getReutersAnalyzer(){
