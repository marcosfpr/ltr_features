package ltr.collections.rotten.retrieval;
 ...
 */
public class RottenRetrieval extends Retrieval<Feature>{
    static final Logger logger = Logger.getLogger(RottenRetrieval.class.getName());
    
	public RottenRetrieval(Analyzer analyzer) {
        super(analyzer);
    }
