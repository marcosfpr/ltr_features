...
/**
 * Analisador de campos para processamento da coleção JRC-Acquis
 */
@SuppressWarnings("deprecation")
public class EuroVocAnalyzer {
    static final Logger logger = Logger.getLogger(EuroVocAnalyzer.class.getName());
    private boolean stemming;
    private boolean stopwords;
    private CharArraySet stopList = null;

    public EuroVocAnalyzer(Boolean stemming, List<String> stopList) {
        this(stemming);
        if(stopList != null) {
    ...
    public EuroVocAnalyzer(Boolean stemming){ //In case of no stopword removing
